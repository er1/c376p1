...
namespace TowerCraft3D
{
    ...
    class world
    {
        ...
        public void setCubeVertices(int worldSize)
        {
            ...
            Vector3 topLeftBack = cubePosition + new Vector3(-1.0f, 1.0f, -1.0f) * cubeSize;
            Vector3 bottomLeftBack = cubePosition + new Vector3(-1.0f, -1.0f, -1.0f) * cubeSize;
            Vector3 topRightBack = cubePosition + new Vector3(1.0f, 1.0f, -1.0f) * cubeSize;
            Vector3 bottomRightBack = cubePosition + new Vector3(1.0f, -1.0f, -1.0f) * cubeSize;
            Vector3 topLeftFront = cubePosition + new Vector3(-1.0f, 1.0f, 1.0f) * cubeSize;
            Vector3 topRightFront = cubePosition + new Vector3(1.0f, 1.0f, 1.0f) * cubeSize;
            Vector3 bottomLeftFront = cubePosition + new Vector3(-1.0f, -1.0f, 1.0f) * cubeSize;
            Vector3 bottomRightFront = cubePosition + new Vector3(1.0f, -1.0f, 1.0f) * cubeSize;
